...
boolean killPhysics = false;
boolean enteringName = false;
boolean enteringPort = false;
boolean enteringIP = false;
...
boolean entering_name = false;
boolean loadingBlueprint = false;
boolean entering_file_path = false;
...
UiText lc_load_new_enterd;
UiText lc_load_notFound;
UiText lc_newf_enterdName;

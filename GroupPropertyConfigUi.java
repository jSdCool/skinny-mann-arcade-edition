...
/**The UI definitions for editing compoent group properties in the toolbox.
*/
public class GroupPropertyConfigUi extends PropertyConfigUi<Integer, IntegerProperty>{

  
  /**The singleton instace of this class
  */
  private static GroupPropertyConfigUi instace;
  ...
  */
  public static GroupPropertyConfigUi getInstace(){
    return instace;
  }
  ...
  */
  public GroupPropertyConfigUi(PGraphics render, UiFrame toolboxUi){
  ...
  */
  public void draw(int slotId, IntegerProperty property, PropertyConfigEnviormentContext context){
    ...
    if(value >= 0){
      valueDisplay.setText(context.getGroupNames()[value]);
    } else {
